        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-6 text-center mb-16">
            ...
            <p className="max-w-2xl text-lg text-gray-600 leading-relaxed">
              All plans include our core transcription technology with varying limits and features
            </p>
          </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="space-y-4">
              ...
              {/* Processing Speed */}
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 py-4 border-b border-gray-200">
                <div className="font-medium text-gray-900">Processing Speed</div>
                <div className="text-center"><Clock className="h-4 w-4 text-yellow-500 mx-auto" /></div>
                <div className="text-center"><Zap className="h-4 w-4 text-blue-500 mx-auto" /></div>
                <div className="text-center"><Zap className="h-4 w-4 text-green-500 mx-auto" /></div>
              </div>

              {/* Security */}
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 py-4 border-b border-gray-200">
                <div className="font-medium text-gray-900">Enterprise Security</div>
                <div className="text-center"><CheckCircle className="h-4 w-4 text-green-500 mx-auto" /></div>
                <div className="text-center"><CheckCircle className="h-4 w-4 text-green-500 mx-auto" /></div>
                <div className="text-center"><Shield className="h-4 w-4 text-green-500 mx-auto" /></div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 py-4 border-b border-gray-200">
                ...
                <div className="text-center"><Headphones className="h-4 w-4 text-blue-500 mx-auto" /></div>
                <div className="text-center"><Award className="h-4 w-4 text-purple-500 mx-auto" /></div>
              </div>
          ...
          <div className="mx-auto grid max-w-6xl items-start gap-12 lg:grid-cols-3">
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed mb-4">
                  Perfect for journalists, students, researchers, and content creators who need accurate transcriptions for personal projects.
                </CardDescription>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold">For Teams</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed mb-4">
                  Ideal for small to medium teams that need reliable transcription services with enhanced features and priority support.
                </CardDescription>
                <div className="space-y-2 text-sm">
                  <div className="flex items-center text-gray-600">
                    <CheckCircle className="mr-2 h-4 w-4 text-green-500" />
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold">For Enterprise</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed mb-4">
                  Comprehensive solution for large organizations with unlimited usage, API access, and dedicated support.
                </CardDescription>
                <div className="space-y-2 text-sm">
                  <div className="flex items-center text-gray-600">
                    <CheckCircle className="mr-2 h-4 w-4 text-green-500" />
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto max-w-4xl space-y-8">
            <Card className="border-l-4 border-l-blue-500">
              ...
              <CardContent>
                <p className="text-gray-600">
                  When you approach your limits, we'll notify you with options to upgrade or purchase additional credits. 
                  Your service won't be interrupted, but additional usage will be billed at standard rates.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-indigo-500">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Yes! You can upgrade or downgrade your plan at any time. Changes are prorated, and you'll only pay 
                  for the difference. Downgrades take effect at your next billing cycle.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Absolutely. All files are encrypted in transit and at rest. We automatically delete files after 24 hours, 
                  and we never use your data for training or any other purposes. Your privacy is our priority.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent>
                <p className="text-gray-600">
                  We offer a 30-day money-back guarantee on all paid plans. If you're not satisfied with our service, 
                  contact our support team for a full refund within the first 30 days.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-2xl text-lg text-blue-100 leading-relaxed">
                Start with our free plan and experience the power of AI-driven transcription today.
              </p>
            </div>
