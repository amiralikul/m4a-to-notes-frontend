  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 bg-grid-slate-100">
      ...
      <main className="flex-1">
        ...
        { isSignedIn && <section className="w-full py-16 md:py-24 bg-white relative">
        ...
        {!isSignedIn && <section className="w-full py-20 md:py-32 bg-gradient-to-b from-gray-50 to-white">
        ...
        {/* Features */}
        {!isSignedIn && <section id="features" className="w-full py-20 md:py-32 bg-white relative overflow-hidden">
