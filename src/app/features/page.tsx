          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-6">
              ...
              <p className="mx-auto max-w-2xl text-lg md:text-xl text-gray-600 leading-relaxed">
                Discover all the powerful features that make AudioScribe the best choice for converting 
                your M4A files to accurate text transcriptions.
              </p>
            </div>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-6 text-center mb-16">
            ...
            <p className="max-w-2xl text-lg text-gray-600 leading-relaxed">
              Our advanced AI-powered features ensure you get the most accurate and efficient transcription experience
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-7xl items-start gap-8 lg:grid-cols-3">
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold">Lightning Fast Processing</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  Convert hours of audio to text in minutes with our optimized OpenAI Whisper processing.
                  Real-time progress tracking keeps you informed throughout the entire process.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold">Industry-Leading Accuracy</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  95%+ accuracy rate with support for multiple languages and accents. 
                  Our advanced AI understands context and delivers professional-quality results.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  ...
                  Enterprise-grade security ensures your data remains completely private.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="grid gap-8">
                <div className="flex items-start space-x-5 group">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-2 text-gray-900">Multi-Language Support</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Support for over 50 languages with automatic language detection. Perfect for 
                      international meetings, interviews, and multilingual content.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5 group">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-2 text-gray-900">Flexible Output Formats</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Export your transcriptions in multiple formats including plain text, formatted documents, 
                      and structured data with timestamps and speaker identification.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5 group">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-2 text-gray-900">Usage Analytics</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Track your transcription usage, monitor accuracy rates, and optimize your workflow 
              ...
              <div className="relative group">
                ...
                <Card className="relative w-full max-w-md shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
                  <CardHeader className="pb-4">
                    ...
                    <CardDescription className="text-gray-500">Real-time feature detection</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium">Speaker Identification</span>
                        <CheckCircle className="h-4 w-4 text-green-500" />
                      </div>
                      <div className="flex items-center justify-between">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-6xl items-start gap-8 lg:grid-cols-3">
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  ...
                  Files up to 25MB supported with secure encryption.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  Our advanced OpenAI Whisper AI analyzes your audio with real-time progress updates.
                  Advanced noise reduction and quality enhancement ensure optimal results.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold">3. Download & Use</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  Get your transcription instantly as clean, formatted text. Copy to clipboard, 
                  download as TXT file, or export in your preferred format.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-2xl text-lg text-blue-100 leading-relaxed">
                Join thousands of professionals who trust AudioScribe for accurate, fast transcriptions.
              </p>
            </div>
