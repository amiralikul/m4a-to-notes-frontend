          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-6">
              ...
              <p className="mx-auto max-w-2xl text-lg md:text-xl text-gray-600 leading-relaxed">
                Have questions about AudioScribe? Need help with your account? Want to explore enterprise solutions? 
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          <div className="mx-auto grid max-w-6xl items-start gap-8 lg:grid-cols-3">
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm group hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed mb-4">
                  Send us an email and we'll get back to you within 24 hours. Perfect for detailed questions 
                ...
                <Button 
                  ...
                  onClick={() => window.location.href = 'mailto:support@audioscribe.com'}
                >
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm group hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed mb-4">
                  Get instant answers to your questions with our live chat support. Available during business hours 
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm group hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed mb-4">
                  ...
                  Available for Pro and Business plan customers.
                </CardDescription>
                <Button 
                  variant="outline" 
          ...
          <div className="mx-auto grid max-w-6xl items-start gap-8 lg:grid-cols-4">
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg font-semibold">Technical Support</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-sm text-gray-600 leading-relaxed">
                  Issues with uploads, transcription quality, account access, or billing questions.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg font-semibold">Enterprise Sales</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-sm text-gray-600 leading-relaxed">
                  Custom solutions, volume pricing, API integration, and enterprise features.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <CardContent>
                <CardDescription className="text-sm text-gray-600 leading-relaxed">
                  Integration opportunities, reseller programs, and strategic partnerships.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg font-semibold">General Inquiries</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-sm text-gray-600 leading-relaxed">
                  Product questions, feature requests, feedback, or anything else we can help with.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-2xl text-lg text-blue-100 leading-relaxed">
                Don't wait – start transcribing your audio files today with AudioScribe's 
