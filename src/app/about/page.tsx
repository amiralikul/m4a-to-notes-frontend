          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-6">
              ...
              <p className="mx-auto max-w-2xl text-lg md:text-xl text-gray-600 leading-relaxed">
                AudioScribe was born from a simple belief: everyone deserves easy access to the information 
                locked away in audio files. We're making transcription faster, more accurate, and more accessible than ever.
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="/">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white h-14 px-8 rounded-xl">
                  Try AudioScribe
                </Button>
              </Link>
              <Link href="/contact">
                <Button size="lg" variant="outline" className="h-14 px-8 rounded-xl border-gray-300">
                  Get in Touch
                </Button>
              </Link>
            </div>
            ...
            <div className="flex flex-col justify-center space-y-8">
              <div className="space-y-6">
                <div className="flex items-start space-x-5 group">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      To create a world where information in audio format is as searchable, accessible, 
                      and useful as written text. We believe technology should break down barriers, not create them.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5 group">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      always seeking new ways to improve accuracy, speed, and user experience.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5 group">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-2 text-gray-900">Privacy by Design</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Your data is yours. We built AudioScribe with privacy at its core, ensuring your files 
                      are secure, encrypted, and automatically deleted after processing.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <Card className="relative w-full max-w-md shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
                  <CardHeader className="pb-4">
                    ...
                    <CardDescription className="text-gray-500">Transforming workflows worldwide</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium">Hours Transcribed</span>
          ...
          <div className="mx-auto grid max-w-6xl items-start gap-8 lg:grid-cols-3">
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold">User-Centric Design</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  Every feature we build starts with understanding our users' needs. We believe great technology 
                  should be invisible – powerful yet simple to use.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold">Excellence in Everything</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  We're not satisfied with "good enough." From accuracy rates to user experience, 
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold">Global Accessibility</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600 leading-relaxed">
                  Language should never be a barrier to accessing information. We're committed to 
                  supporting languages and dialects from around the world.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mx-auto max-w-4xl">
            <div className="space-y-12">
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-2">
                    <h3 className="text-xl font-bold text-gray-900">The Spark</h3>
                    <Badge variant="secondary" className="text-xs">2023</Badge>
                  </div>
                  <p className="text-gray-600 leading-relaxed">
                    Frustrated by the time-consuming process of manually transcribing interviews and meetings, 
                    our founders set out to create a better solution. The goal was simple: make transcription 
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-2">
                    <h3 className="text-xl font-bold text-gray-900">Building the Foundation</h3>
                    <Badge variant="secondary" className="text-xs">2023</Badge>
                  </div>
                  <p className="text-gray-600 leading-relaxed">
                    Months of research, development, and testing led to our first prototype. We focused on 
                    creating a system that prioritized accuracy, speed, and user privacy from day one.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-2">
                    <h3 className="text-xl font-bold text-gray-900">Launch & Growth</h3>
                    <Badge variant="secondary" className="text-xs">2024</Badge>
                  </div>
                  <p className="text-gray-600 leading-relaxed">
                    AudioScribe launched to an enthusiastic response from early users. Their feedback helped 
                    us refine our service and add features that matter most to real-world workflows.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Today, AudioScribe serves thousands of users worldwide, processing millions of minutes 
                    of audio monthly. We're just getting started on our mission to make audio accessible to everyone.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-6 text-center mb-16">
            ...
            <p className="max-w-2xl text-lg text-gray-600 leading-relaxed">
              We're a passionate team of engineers, designers, and researchers united by a common goal: 
              making audio content accessible to everyone.
            </p>
          </div>
            ...
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm p-8">
              <div className="text-center space-y-6">
                <div className="flex justify-center space-x-4 flex-wrap">
                  <Badge variant="secondary" className="mb-2">Engineering</Badge>
                  <Badge variant="secondary" className="mb-2">AI/ML Research</Badge>
                  <Badge variant="secondary" className="mb-2">User Experience</Badge>
                  <Badge variant="secondary" className="mb-2">Product Design</Badge>
                  <Badge variant="secondary" className="mb-2">Customer Success</Badge>
                </div>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Our diverse team brings together expertise in machine learning, software engineering, 
                  user experience design, and customer success. We're distributed across multiple time zones 
                  but united by our commitment to building the best transcription service possible.
                </p>
          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-2xl text-lg text-blue-100 leading-relaxed">
                Join thousands of professionals who trust AudioScribe to convert their audio content 
                into accessible, searchable text.
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="/">
                <Button size="lg" variant="secondary" className="h-14 px-8 rounded-xl bg-white text-blue-600 hover:bg-gray-50">
                  <Sparkles className="mr-2 h-5 w-5" />
                  Try AudioScribe Now
                </Button>
              </Link>
              <Link href="/contact">
                <Button size="lg" variant="outline" className="h-14 px-8 rounded-xl border-white text-white hover:bg-white/10">
                  Get in Touch
                </Button>
              </Link>
            </div>
