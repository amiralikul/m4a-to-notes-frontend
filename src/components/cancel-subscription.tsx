...
export function CancelSubscription({ 
  ...
  const canCancel = entitlements?.status && ['active', 'trialing', 'past_due'].includes(entitlements.status);
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="text-sm font-medium">Choose cancellation method:</div>
            
            {/* Customer Portal Option (Recommended) */}
            <Card 
              className={`cursor-pointer transition-colors ${
                cancellationMethod === 'portal' ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:bg-gray-50'
              }`}
            ...
            <Card 
              className={`cursor-pointer transition-colors ${
                cancellationMethod === 'direct' ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:bg-gray-50'
              }`}
        ...
        <DialogFooter className="flex gap-2">
          ...
          <Button 
            onClick={cancellationMethod === 'portal' ? handleCustomerPortal : handleDirectCancel}
...
export function CancellationSuccess({ method, onClose }) {
  return (
