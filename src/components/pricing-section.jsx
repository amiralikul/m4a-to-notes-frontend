...
export function PricingSection() {
  const { entitlements, loading, getCurrentPlan, hasActiveSubscription } = useEntitlements();
    ...
    <section id="pricing" className="w-full py-12 md:py-24 lg:py-32 bg-muted">
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 lg:grid-cols-3 lg:gap-8">
          {/* Free Plan */}
          <Card className={`relative ${getCurrentPlan() === 'free' && hasActiveSubscription() ? 'ring-2 ring-green-500' : ''}`}>
            {getCurrentPlan() === 'free' && (
          ...
          {/* Pro Plan */}
          <Card className={`relative ${getCurrentPlan() === 'pro' && hasActiveSubscription() ? 'ring-2 ring-green-500' : 'border-primary'}`}>
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
            ...
            <CardHeader className="text-center">
              ...
              <div className="text-4xl font-bold">${PRICING_PLANS.PRO.price}<span className="text-lg font-normal">/month</span></div>
          ...
          {/* Business Plan */}
          <Card className={`relative ${getCurrentPlan() === 'business' && hasActiveSubscription() ? 'ring-2 ring-green-500' : ''}`}>
            ...
            <CardHeader className="text-center">
              <CardTitle className="text-2xl">{PRICING_PLANS.BUSINESS.name}</CardTitle>
              <div className="text-4xl font-bold">${PRICING_PLANS.BUSINESS.price}<span className="text-lg font-normal">/month</span></div>
