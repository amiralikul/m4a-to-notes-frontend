    ...
    <Card className="border-2 border-dashed border-gray-300 bg-gray-50">
      ...
      <CardContent className="text-center space-y-4">
        <div className="text-sm text-gray-600">
          <p>Your current plan: <strong className="capitalize">{entitlements?.plan || 'free'}</strong></p>
          <p>Required plan: <strong className="capitalize">{requiredPlan}</strong></p>
        </div>
 ...
 */
export function BusinessOnly({ children }) {
  return (
    <ProFeature
      requiredPlan="business"
